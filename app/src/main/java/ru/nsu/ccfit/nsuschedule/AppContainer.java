...
public class AppContainer {
    ...
    public AppContainer(Context context) throws IOException {
        ...
        Repository repository = new JsonRepository(context);
        scheduleDayViewModelFactory = createFactory(unused ->
                new ScheduleDayViewModel(new GetEventsForDay(repository), new RemoveEvent(repository), timeFormat, R.menu.event_context_menu));
    ...
    public void initDownloadedScheduleViewModelFactory(Repository repository) {
